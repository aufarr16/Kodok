...
class Controller_ManagerSearchDocuments extends Controller
{
    public function openPage(){
    	...
    	return view('Pages.Manager.View_ManagerSearchDocuments', ['data_search' => $data_search]); 	
    }

    // return redirect('/manager/ ')->with('success','Dokumen berhasil download');

    // return redirect('/manager/ ')->with('success','Dokumen berhasil terkirim');
}
