...
<div class="row mt-2">
<div class="col-md-12">
  <div id="filter" class="card card-outline card-primary collapsed-card">
    ...
    <div class="card-tools">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-4 col-sm-6 col-12">
            <div class="form-group">
              <label>PIC</label>
                <select id="filter-pic" class="select2 form-control filter" data-column="1" style="width: 100%;">
                  <option value="">-</option>
                  @foreach($pic as $p)
          ...
          <div class="col-md-4 col-sm-6 col-12">
            <div class="form-group">
              <label>Product</label>
                <select id="filter-product" class="select2 form-control filter" data-column="2" style="width: 100%;">
                  <option value="">-</option>
                  @foreach($prod as $pr)
          ...
          <div class="col-md-4 col-sm-6 col-12">
            <div class="form-group">
              <label>Mitra</label>
                <select id="filter-mitra" class="select2 form-control filter" data-column="4" style="width: 100%;">
                  <option value="">-</option>
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 col-12">
            <label>Project</label>
            <input id="filter-namap" data-column="5" type="search" class="form-control filter" placeholder aria-controls="table1">
          </div>

          <div class="col-md-4 col-sm-6 col-12">
            <div class="form-group">
              <label>Jenis Project</label>
                <select id="filter-ptype" class="select2 form-control filter" data-column="3" style="width: 100%;">
                  <option value="">-</option>
          ...
          <div class="col-md-4 col-sm-6 col-12">
            <div class="form-group">
              <label>Status</label>
                <select id="filter-pstat" class="select2 form-control filter" data-column="7" style="width: 100%;">
                  <option value="">-</option>
    ...
    <!-- /.card-header -->
  <div id="tabel" class="card card-primary card-outline">
    <div class="card-body">
