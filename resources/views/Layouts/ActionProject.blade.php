...
<button href="{{ $url_progress }}" type="button" class="modal-show btn btn-warning btn-edit" data-toggle="tooltip" data-placement="top" title="Ubah Progress" data-target="#modal"><i class="far fa-edit"></i></button>