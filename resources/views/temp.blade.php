          ...
          <form method="post" action="/admin/submituser">
            ...
            <div class = "form-group">
              <div class ="input-group-addon">
                ...
                <input type="text" id="inisial_user" class="form-control" style="margin-bottom: 10px">
              <div class ="input-group-addon">
                <label for="nama_user" style="font-weight:bolder; float: left;">Nama</label>
              </div>  
                <input type="text" id="nama_user" class="form-control" style="margin-bottom: 10px;">            
              <div class ="input-group-addon">            
                <label for="id_ulevel" style="font-weight:bolder;float: left;">Role</label>
              </div>
                <select id="id_ulevel" class="form control" style="height:35px;"> 
              ...
              <div class ="input-group-addon">
                ...
                <input type="email" id="email_user" class="form-control" style="float: right; margin-bottom: 10px">
            </div>
            <button onclick="submituser()" class="btnsubmit" type="button" id="submituser">Submit</button>
          </form>
          <!-- ./modal body -->
          </div>
        <!-- ./modal content -->
